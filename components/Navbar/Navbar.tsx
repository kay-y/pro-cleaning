            ...
            <div className="max-w-292.5 w-full mx-auto">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <button onClick={() => setOpen(!isOpen)} className="lg:hidden flex items-center justify-center z-50" title="Toggle navigation menu"><Menu color="black" size={'2rem'} /></button>
                    </div>
